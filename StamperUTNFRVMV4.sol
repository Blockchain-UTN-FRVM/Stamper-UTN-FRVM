...
import "https://github.com/OpenZeppelin/openzeppelin-solidity/blob/v2.5.0/contracts/ownership/Ownable.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.5.0/contracts/utils/EnumerableSet.sol";

contract StamperUTNFRVMV4 is Ownable {
    ...
    event Stamped(bytes32 indexed hash, uint256 indexed idUsuario, uint256 blockNo, address contractAddress);
    ...
    function postHash(bytes32[] calldata hashList, uint256 idUsuario) external onlyAuthorized returns (bytes32[] memory, bytes32[] memory) {
